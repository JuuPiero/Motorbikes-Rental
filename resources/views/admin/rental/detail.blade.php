...
<div class="container-fluid">
    <a href="
    {{-- {{ route('admin.invoice.create', $order->id) }} --}}
     " class="btn btn-primary text-black mb-2">Print Invoice</a>
    <a href="
    {{-- {{ route('admin.invoice.show', $order->id) }} --}}
     " class="btn btn-primary text-black mb-2">Show Invoice</a>
    ...
    <div class="block">
        ...
        <p><strong>Phone Number : </strong> {{ $rental->user->phone_number }}</p>
        ...
        <form style="margin-top: 20px" class="form-horizontal" method="POST" action="{{ route('admin.rental.update', $rental->id) }}" enctype="multipart/form-data">
            ...
            @if($rental->status == 'Completed')
                <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                        <input value="Completed" disabled readonly type="text" class="form-control is-valid">
                    </div>
                </div>
            @else
                <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                        <select name="status" class="form-control is-invalid">
                            ...
                            <option value="Renting">Paid</option>
